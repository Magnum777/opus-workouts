"""
Sell BIRB and SKR with skipPreflight
"""
...
# Sell BIRB first (60 tokens = 60000000 lamports)
print("=== SELLING BIRB ===")
amount_birb = 60289091
r = requests.get(f"https://lite-api.jup.ag/swap/v1/quote?inputMint={BIRB}&outputMint={SOL}&amount={amount_birb}&slippage=20", timeout=15)
quote = r.json()
...
print(f"BIRB Result: {result.value if hasattr(result, 'value') else result}")
