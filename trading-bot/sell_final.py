...
TOKEN = "GaGh1vcw8NqArWuuqU2fwfmTUhxmWpnY38QKiZjUZwYM"
SOL = "So11111111111111111111111111111111111111112"

amount = 930689006
print("Selling", amount, "lamports -> SOL")

r = requests.get(f"https://lite-api.jup.ag/swap/v1/quote?inputMint={TOKEN}&outputMint={SOL}&amount={amount}&slippage=20", timeout=15)
quote = r.json()
print("Quote:", quote.get("outAmount"), "lamports SOL")
...
print("Result:", result.value if hasattr(result, "value") else result)
